...
const SectionOne = () => {
  ...
  const formik = useFormik({
    ...
    onSubmit: (data) => {
      ...
      history.push(PATH_FORM.userSectionTwo);
    }
  });
      ...
      <Container>
        <Box mb={2}>
          ...
          <Typography display="block" mb={2} variant="body">
            ...
            identificar. Conte um problema vivido pela sua comunidade ou até
            mesmo pessoal!
          </Typography>
          <Typography display="block" mb={2} variant="body">
          ...
          <Typography display="block" mb={2} variant="body">
            ...
            983200546 ou no nosso e-mail contato@luzconecta.com.br e caso se
            sinta mais a vontade você pode até mesmo nos contar seu problema por
            lá.
          </Typography>
          <Typography display="block" mb={2} variant="body">
          ...
          <Typography display="block" mb={2} variant="body">
            ...
            Desenvolvimento Sustentável) em que seu problema mais se encaixa,
            não esquece de deixá-lo registrado na penúltima pergunta deste
            formulário.
          </Typography>
        </Box>
          ...
          <Form autoComplete="off" noValidate onSubmit={handleSubmit}>
            ...
            <Card sx={{ mb: 4 }}>
              <CardContent>
                <FormControl
                  error={Boolean(
                    touched['problemResponsible'] &&
                      errors['problemResponsible']
                  )}
                >
                  <CheckboxGroupForm
