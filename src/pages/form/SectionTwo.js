...
// components
import { RadioGroupForm, InterestQuestion, Page } from '../../components';
// paths
...
const SectionTwo = () => {
  ...
  const formik = useFormik({
    initialValues: {
      contactByPhone: contactByPhone.toString() || '',
      contactByApp: contactByApp.toString() || '',
      contactByWhatsapp: contactByWhatsapp.toString() || '',
      contactByChatbot: contactByChatbot.toString() || '',
      contactByWebpage: contactByWebpage.toString() || '',
    ...
    onSubmit: (data) => {
      ...
      history.push(PATH_FORM.userSectionThree);
    }
  });
          ...
          <Form autoComplete="off" noValidate onSubmit={handleSubmit}>
            ...
            <Card sx={{ mb: 4 }}>
              <CardContent>
                <FormControl
                  error={Boolean(
                    touched['elapsedTime'] && errors['elapsedTime']
                  )}
                >
                  <RadioGroupForm
                    name="elapsedTime"
            ...
            {values['acceptContact'] === 'yes' ? (
              <Card sx={{ mb: 4 }}>
                <CardContent>
                  <Typography mb={1} variant="h6">
                    Caso tenha respondido sim, por favor informe seu nome,
                    e-mail ou número telefone/ WhatsApp.
                  </Typography>
                  <TextField
                    name="contact"
                    type="text"
            ...
            <Box display="flex" justifyContent="space-between">
              <Button
                variant="outlined"
                size="large"
                onClick={() => history.push(PATH_FORM.userSectionOne)}
              >
                Voltar
              </Button>
